...
def model_picker_page():
    ...
    st.markdown("Customize your AI experience by selecting between local processing or external high-performance models.")
    ...
    provider = st.radio(
        ...
        provider_options,
        index=provider_idx,
        help="Local uses Ollama. ALCF uses models hosted on Argonne computers and requires authentication. OpenAI uses standard cloud models."
    )
    ...
    if provider == "Local":
        known_models = ["qwen3.5:latest", "gemma3:4b"]
    elif provider == "ALCF":
